...
const steps = [
  'Revisamos tu caso',
  'Determinamos la contingencia',
  'Diseñamos un plan de acción',
  'Preparamos el escrito legal',
  'Presentamos la respuesta virtual',
];
  ...
  return (
    <section className="sunat-alert">
      <div className="container sunat-inner">
        <div className="sunat-l">
          <span className="eyebrow"><span className="dot"></span>Defensa tributaria</span>
          <h2>¿Recibiste una comunicación de <em>SUNAT</em>?</h2>
          <ul className="sunat-alerts">
            {alerts.map(a => (
              <li key={a}>{a}</li>
            ))}
          </ul>
        ...
        <div className="sunat-r">
          <p className="sunat-nosotros">Nosotros nos encargamos:</p>
