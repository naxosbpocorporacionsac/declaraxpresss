  ...
  return (
    <section className="formaliza">
      <div className="container formaliza-inner">
        <div className="formaliza-l">
          <h2>Formaliza tu <em>emprendimiento</em></h2>
          <p className="formaliza-sub">Constituye tu empresa fácil y rápido.</p>
        ...
        <div className="formaliza-r">
          <div className="formaliza-card">
            <p className="formaliza-desde">Desde</p>
            <div className="formaliza-price">
              <span className="cur">S/</span>
              <span className="amt">370</span>
            </div>
            <p className="formaliza-note">Pago único · Sin mensualidad</p>
